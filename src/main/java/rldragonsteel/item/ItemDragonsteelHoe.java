...
public class ItemDragonsteelHoe extends ItemHoe implements DragonsteelHitEffect {

	public ItemDragonsteelHoe(ToolMaterial toolmaterial, String gameName, String name) {
		super(toolmaterial);
