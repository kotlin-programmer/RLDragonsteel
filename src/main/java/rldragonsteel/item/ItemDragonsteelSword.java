...
public class ItemDragonsteelSword extends ItemSword implements DragonsteelHitEffect {

	private final ToolMaterial toolMaterial;

	public ItemDragonsteelSword(ToolMaterial toolmaterial, String gameName, String name) {
		super(toolmaterial);
