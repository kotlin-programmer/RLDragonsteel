...
public class ItemDragonsteelAxe extends ItemAxe implements DragonsteelHitEffect {

	public ItemDragonsteelAxe(ToolMaterial toolmaterial, String gameName, String name) {
		super(toolmaterial, (float) RLDragonsteelConfig.MISC_SETTINGS.dragonsteelBaseDamage + 4F, -3);
