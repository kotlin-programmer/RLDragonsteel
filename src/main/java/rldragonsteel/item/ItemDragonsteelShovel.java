...
public class ItemDragonsteelShovel extends ItemSpade implements DragonsteelHitEffect {

	public ItemDragonsteelShovel(ToolMaterial toolmaterial, String gameName, String name) {
		super(toolmaterial);
